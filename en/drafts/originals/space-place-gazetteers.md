...
As our second research question ties into questions of Jewish history, we will add a column for whether there is a Jewish population in the place and an additional column that includes further information about the description of the Jewish population. Call this column, "JewishPop." 
...
To start, we will need to fill in the correspodning data for our different column headers that we have created. First, go through the first pargraph of text and put each name of a stop in the "TravelStop" column.
